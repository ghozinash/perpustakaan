        ...
        <form class="form-horizontal" method="POST" action="<?= base_url() ?>buku/simpan">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" name="thn_terbit" class="form-control" placeholder="2000" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label">Jumlah</label>
                    <div class="col-sm-10">
                        <input type="number" name="jumlah" class="form-control" placeholder="50" required>
                    </div>
                </div>
